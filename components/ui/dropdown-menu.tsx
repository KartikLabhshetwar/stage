...
/**
 * Portal wrapper for Dropdown Menu
 */
...
/**
 * Content area of the dropdown menu
 * @param sideOffset - distance from trigger (default: 4)
 */
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover/95 backdrop-blur-xl border-border/50 text-popover-foreground " +
            ...
            "rounded-lg border p-1 shadow-md",
          className
        )}
        {...props}
      />
...
/**
 * Single clickable item in the dropdown menu
 * @param inset - add extra padding-left
...
/**
 * Radio group wrapper in dropdown menu
 */
    ...
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-popover/95 backdrop-blur-xl border-border/50 text-popover-foreground " +
          ...
          "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 " +
          "data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 " +
          "min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-lg border p-1 shadow-lg",
        className
      )}
      {...props}
    />
