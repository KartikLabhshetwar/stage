...
export const TextOverlayControls = () => {
  const { textOverlays, addTextOverlay, updateTextOverlay, removeTextOverlay, clearTextOverlays } =
    useImageStore()
      ...
      {selectedOverlay && (
        <div className="space-y-5 border-t pt-5">
          <div className="space-y-5">
            ...
            <Select value={selectedOverlay.fontFamily} onValueChange={handleUpdateFontFamily}>
          ...
          <Select value={selectedOverlay.fontWeight} onValueChange={handleUpdateFontWeight}>
            <SelectTrigger className="w-full h-11 rounded-xl border-border focus:border-primary focus:ring-2 focus:ring-ring">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            {getAvailableFontWeights(selectedOverlay.fontFamily).length !== 1 ? 's' : ''} available
          </p>

          <Select value={selectedOverlay.orientation} onValueChange={handleUpdateOrientation}>
            <SelectTrigger className="w-full h-11 rounded-xl border-border focus:border-primary focus:ring-2 focus:ring-ring">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/50">
                  ...
                  <div className="flex-1 flex items-center gap-3">
                    <Slider
                      ...
                      onValueChange={(value) => handleUpdateTextShadow({ blur: value[0] })}
                      max={20}
                      min={0}
                      step={1}
                    />
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/50">
                  ...
                  <div className="flex-1 flex items-center gap-3">
                    <Slider
                      ...
                      onValueChange={(value) => handleUpdateTextShadow({ offsetX: value[0] })}
                      max={20}
                      min={-20}
                      step={1}
                    />
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/50">
                  ...
                  <div className="flex-1 flex items-center gap-3">
                    <Slider
                      ...
                      onValueChange={(value) => handleUpdateTextShadow({ offsetY: value[0] })}
                      max={20}
                      min={-20}
                      step={1}
                    />
